package com.taleckij_anton.taleckijapp.metrica_help;

/**
 * Created by Lenovo on 11.02.2018.
 */

public class MetricaAppEvents {
    public static final String AppsGridOpen = "AppsGridOpen";
    ...
    public static final String ProfileOpen = "ProfileOpen";
